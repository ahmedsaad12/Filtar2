package com.app.filtar.notifications;
...
import com.app.filtar.share.App;
...
public class FireBaseNotifications extends FirebaseMessagingService {
    ...
    private void manageNotification(Map<String, String> map) {
        ...
        NotificationCompat.Builder notificationCompat = new NotificationCompat.Builder(this, App.CHANNEL_ID)
                ...
                .setSound(Uri.parse(sound_Path), AudioManager.STREAM_NOTIFICATION).setGroup("Filtar")
        ...
        if (notification_type.equals("100")||notification_type.equals("200")||notification_type.equals("300")) {
            ...
            manager.notify(random, notificationCompat.build());
